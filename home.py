...
def go_to_account_page():
    # Creates the account page and switch to it
    account_page = AccountPage(root)
    account_page.pack(fill="both", expand=True)  # Makes sure this is packed
...
background_label.place(relwidth=1, relheight=1)  # Covers the entire window
